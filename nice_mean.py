...
#
# Purpose: The Tech Academy Python Course, creating first program. Demonstrating how to pass
#          variables from function to function while producing a functional game.
#
...
def win(nice,mean,name):
    ...
    print("\nNice job {}, you win! \nEveryone loves you and you've \nbut you might be a pushover!".format(name))
...
def reset(nice,mean,name):
    nice = 0
    mean = 0
    # Notice the name variable isn't reset as that same player has elected to play again
